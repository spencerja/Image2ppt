...
class View():
    ...
    def prepare_advanced_tab(self):
        ...
        self.start_process_button_advanced = self.components.create_button(self.advanced_frame, "Start", 1, 3)
        self.save_config_button_advanced  = self.components.create_button(self.advanced_frame,"Save Config",1,4)
